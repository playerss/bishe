	...
	<div align="center">
	    <div style="width:100%;" >
			...
			<div style="width: 1100px; margin-top: 10px; border:1px solid #ccc;">
				...
				注册会员</div>
				<form action="register" name="login" method="post" onsubmit="return check(this)">
								...
								<div id="divlogin"
									...
									<table cellpadding="3" align="center">
										...
										<tr style="height: 50px">
											...
											<td align="left"><input type="password" name="txtRePass" id="txtRePass" size="20" /></td>
										</tr>
										<tr style="height: 50px">
											<td></td>
											<td colspan="1" align="left"><input type="image" src="../img/register.png" /></td>
										</tr>
