	...
	with(form){
		...
		if(txtPass.value==""){
			...
			<div style="width: 1100px; margin-top: 10px; border:1px solid #ccc;">
				...
				会员登录</div>
				<form action="/bishe3/login" name="login" method="post" onsubmit="return check(this)">
					<table width="100%" cellpadding="0" cellspacing="0" align="center">
						<tr>
							<td valign="top"><br /> <br /> <br />
								<div id="divlogin"
									style="text-align: center; padding: 4px 4px 0px 4px; width: 100%; margin-bottom: 60px;margin-top:40px;">
									<div style="height: 22px; font-size: 22px; font-weight: bold; margin-bottom: 20px;">登&nbsp&nbsp录</div>
									<table cellpadding="3" align="center">
										...
										<tr style="height: 50px">
											...
											<td colspan="1" align="left">
												<input  src="../img/login.png" style="border:0px;" type="image"/>
												<!-- <input type="image" src="../img/login.png" onclick="javascript:window.location.href='product_info_publish.jsp'"/>
												<input type="button" src="../img/login.png" onclick="javascript:window.location.href='product_info_publish.jsp'"/>
													button类型可以，但是图片不能显示，上面一种为image类型，onclick事件无效 -->
											</td>
										</tr>
									</table>
								</div>
