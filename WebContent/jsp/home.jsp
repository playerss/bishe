<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.my.*,java.util.List"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<script type="text/javascript" src="bishe3/jquery-3.2.1.min.js"></script>
...
<body>
	<div align="center">
	    <div style="width:100%;" >
			<div style="width: 1300px; height: 80px; margin-right: 5px;">
				<form action="/bishe3/querykey_production" method="post" style="border: 0px; padding: 0px;">
					...
					<div style="float: left; width: 180px; text-align: right; margin-top: 20px;">
						<input id="key" type="text" name="key" maxlength="100"
							style="height: 30px; width: 180px; font-size: 16px; padding-top: 2px; padding-left: 5px; border: 1px solid #ccc;"
							value="" />
					</div>
					<div style="float: left; width: 37x; text-align: right; margin-top: 20px;">
						<input type="image" src="img/search.png" id="ss"/>
					</div>
				</form>
				...
				<div style="width: 1100px;">
					<div align="left" style="color: #cccccc;">
						...
						<div style="width: 300px; float: right; text-align: right; height: 40px; color: #fff; line-height: 40px; font-size: 9px;">
							<a href="/bishe3/index.jsp" class="menu">个人主页</a> &nbsp; | &nbsp;
							...
							<div style="background-color: #ffffff; border: 1px solid #DDDDDD; text-align: left;">
								<div style="margin: 10px;">
									<div style="color: #333; padding: 0px 0px 6px 0px; width: 260px; float: left;">
										<a href="#" class="f12dh">闽台农产品线上交易平台</a> > <span
								...
								<div id="ContentMain_lblTopList" style="border-top: 1px solid #eee; padding: 0px 0px; margin: 4px 0px 0px 0px;">
									...
									String isquery=(String)session.getAttribute("isquery");
									System.out.println(isquery);
									List<production> list=database_users.queryall_production();
									if(isquery=="yes")
									{
										list=(List<production>)session.getAttribute("list");
									...
									{%>
										...
										<li class='lileft'>
											...
											<a href="production_show.jsp?sid=<%=list.get(i).getProductionId() %>" class="xtitle_red" target="_blank"><%=list.get(i).getTitles() %></a>
										</li>
										<li class='lileft2'>
											<a href="#" style='color: #999999'><%=list.get(i).getListedsheng()%></a> 
											<a href="#" title='常德' style='color: #999999'><%=list.get(i).getListedshi() %></a></li>
										<li class='liright'><%=list.get(i).getUpdatetime() %></li>
										<li class='clear'></li>
									</ul>
									<%}
									%>
